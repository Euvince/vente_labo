      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="acceuil" class="navbar-link">Acceuil</a>
          </li>

          <li class="navbar-item">
            <a href="Apropos/apropos" class="navbar-link">A propos</a>
          </li>

          <li class="navbar-item">
            <a href="nosproduits" class="navbar-link">Nos produits</a>
          </li>

          <li class="navbar-item">
            <a href="Contact/contact" class="navbar-link">Contact</a>
          </li>
